...
//       case 1:
//         return Center(child: Text("Settings Page", style: TextStyle(fontSize: 22)));
//       case 2:
//         return Center(child: Text("Reports Page", style: TextStyle(fontSize: 22)));
//       default:
//         return Container();
//     }
//   }
...
//                           bool mainSelected = controller.selectedIndex.value == index &&
...
//                                           color: mainSelected ? AppColor.primary : Colors.grey,
//                                         ),
...
//                                               menu,
//                                               style: TextStyle(
//                                                 color: mainSelected ? AppColor.primary : Colors.black,
//                                                 fontWeight: mainSelected ? FontWeight.bold : FontWeight.normal,
//                                               ),
...
//                               // Settings Submenu
//                               if (menu == "Settings" && controller.isExpanded(menu))
//                                 Column(
//                                   children: controller.settingsSubmenu.map((sub) {
//                                     return Obx(() {
//                                       bool isSelected = controller.selectedSubmenu.value == sub;
//                                       return MouseRegion(
//                                         cursor: SystemMouseCursors.click,
//                                         child: InkWell(
//                                           onTap: () => controller.openSubmenuPage(sub),
//                                           child: Container(
...
//                               // Reports Submenu
//                               if (menu == "Reports" && controller.isExpanded(menu))
//                                 Column(
//                                   children: controller.reportsSubmenu.map((sub) {
//                                     return Obx(() {
//                                       bool isSelected = controller.selectedSubmenu.value == sub;
//                                       return MouseRegion(
//                                         cursor: SystemMouseCursors.click,
...
//                                               children: [
//                                                 Icon(
//                                                   controller.reportsSubmenuIcons[sub],
//                                                   size: 18,
//                                                   color: isSelected ? AppColor.primary : Colors.grey[700],
//                                                 ),
//                                                 const SizedBox(width: 10),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: List.generate(
                            controller.menuItems.length, (index) {
                          String menu = controller.menuItems[index];
                          bool mainSelected = controller.selectedIndex.value ==
                                  index &&
                              controller.selectedSubmenu.value.isEmpty;
                              ...
                              if (menu == "Settings" && controller.isExpanded(menu))
                                Column(
                                  children: controller.settingsSubmenu.map((sub) {
                                    return Obx(() {
                                      bool isSelected =
                                          controller.selectedSubmenu.value == sub;
                                      return MouseRegion(
                                        cursor: SystemMouseCursors.click,
                                        child: InkWell(
                                          onTap: () =>
